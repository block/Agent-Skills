...
Breakdown exposes local, authenticated MCP tools while the app is running. Discover the live tool schemas from the connected server; this list helps select a useful surface.
